  ...
  , run: { enumerable: true,
        value: function(){
            ...
            try {
                ...
                this.execfn.call(this, system, page, message.bind(this), resolve.bind(this), reject.bind(this))
            } catch(e) {
              if ( config.debug )
...
var TaskExec = function(id, query){
    ...
    try {
        this.execfn = new Function("system", "page", "message", "resolve", "reject", ["return ", query.shift(), "(system, page, message, resolve, reject)"].join("")).bind(this)
    } catch(e){
      error(e)
    }
