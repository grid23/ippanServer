...
module.exports.SocketEvt = klass(Event, statics => {
    ...
    return {
        constructor: function(socket){
            ...
            events.get(this).get("socket", socket)
        }
...
const SocketTextMessageEvt = klass(SocketMessageEvt, statics => {
    ...
    return {
        constructor: function(e){
            ...
            events.get(this).set("buffer", events.get(e).buffer)
            events.get(this).set("fin", events.get(e).fin)
            events.get(this).set("rsv1", events.get(e).rsv1)
            events.get(this).set("rsv2", events.get(e).rsv2)
            events.get(this).set("rsv3", events.get(e).rsv3)
            events.get(this).set("opcode", events.get(e).opcode)
            events.get(this).set("op", events.get(e).op)
            events.get(this).set("masked", events.get(e).masked)
            events.get(this).set("mask", events.get(e).mask)
            events.get(this).set("length", events.get(e).length)
            events.get(this).set("start", events.get(e).start)
        }
    }
})
