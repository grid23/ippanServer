...
module.exports.PhantomSandbox = klass(Node, ReadyStateFul, statics => {
    ...
    return {
        constructor: function({ port, min, max, data = {}, verbose = false }={}){
            Node.call(this)
            ...
            sandboxes.get(this).set("ready", Promise.resolve()
              ...
              .then(() => Promise.all([
                ...
                , new Promise(resolve => {
                        sandboxes.get(this).set("phantom", spawn(PHANTOM_BIN_PATH, [sandbox_script, this.port, !!verbose ? 1: 0, JSON.stringify(data)]))
